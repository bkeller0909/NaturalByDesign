...
namespace NBDv2.Controllers
{
    public class BidReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,EstBID,Hours,EstHours,Costs,EstCost,HoursRemaining,CostsRemaining,ProjectID")] BidReport bidReport)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,EstBID,Hours,EstHours,Costs,EstCost,HoursRemaining,CostsRemaining,ProjectID")] BidReport bidReport)
        {
            if (id != bidReport.ID)
            {
                return NotFound();
