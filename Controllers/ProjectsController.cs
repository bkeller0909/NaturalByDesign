...
namespace NBDv2.Controllers
{
    ...
    public class ProjectsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Name,Desc,EstCost,BidDate,EstStartDate,EstFinishDate,StartDate,FinishDate,Cost,BidCustApproved,BidManagementApproved,ClientID")] Project project)
        {
