...
namespace NBDv2.Migrations
{
    ...
    [Migration("20200311174545_prodreports")]
    partial class prodreports
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("NBDv2.Models.ProdReport", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasAnnotation("SqlServer:ValueGenerationStrategy", SqlServerValueGenerationStrategy.IdentityColumn);
            ...
            modelBuilder.Entity("NBDv2.Models.Labour", b =>
                {
                    b.HasOne("NBDv2.Models.ProdReport")
                        .WithMany("Labour")
                        .HasForeignKey("ProdReportID");
